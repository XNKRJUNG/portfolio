...
const Contact = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await fetch("https://w9yo5a80sc.execute-api.us-east-1.amazonaws.com/v1", {
        method: "POST",
        headers: {
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+1 717-590-0043</span>
        ...
        <div className="contact__content">
          ...
          <form className="contact__form">
            ...
            <div className="contact__form-div">
              ...
              <input type="email" name="email" className="contact__form-input" placeholder="Insert your email" value={form.email} onChange={handleChange} />
            </div>

            <div className="contact__form-div contact__form-area">
              <label className="contact__form-tag">Message</label>
              <textarea name="message" cols="30" rows="10" className="contact__form-input" placeholder="Write your message" value={form.message} onChange={handleChange}></textarea>
            </div>
